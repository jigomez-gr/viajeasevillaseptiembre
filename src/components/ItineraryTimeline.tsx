...
const ITINERARY_VIDEOS: { [key: number]: { title: string; filePath: string; youtubeUrl?: string }[] } = {
    ...
    2: [
        ...
        { title: "Mercado Triana", filePath: "/videos_itinerario/dia1/mercado_triana.mp4", youtubeUrl: "https://www.youtube.com/watch?v=oiNAZyGiggs" },
    ...
    5: [
        ...
        { title: "Mariví Blasco & Somoza", filePath: "/videos_itinerario/dia4/marivi_blasco_javier_somoza.mp4", youtubeUrl: "https://www.youtube.com/watch?v=FGakXjrutpc" },
